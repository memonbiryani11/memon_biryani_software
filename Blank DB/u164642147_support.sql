...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2026 at 08:11 PM
...
CREATE TABLE `expenses` (
  ...
  `date` date NOT NULL,
  `expense_day` varchar(15) NOT NULL,
...
CREATE TABLE `user_notifications` (
  ...
  `is_cleared` tinyint(4) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `sell_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sell_record_id` (`sell_record_id`);
...
--
ALTER TABLE `expenses`
  ADD CONSTRAINT `expenses_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `sell_items`
  ADD CONSTRAINT `sell_items_ibfk_1` FOREIGN KEY (`sell_record_id`) REFERENCES `sell_records` (`id`) ON DELETE CASCADE;
